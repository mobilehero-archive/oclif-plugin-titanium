...
oclif-plugin-titanium/0.0.9 darwin-x64 node-v10.16.0
$ mobile --help [COMMAND]
USAGE
  $ mobile COMMAND
...
...
_See code: [src/commands/app/create.js](https://github.com/brentonhouse/oclif-plugin-titanium/blob/v0.0.9/src/commands/app/create.js)_
<!-- commandsstop -->
